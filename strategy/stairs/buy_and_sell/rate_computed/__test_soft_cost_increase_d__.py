...
from strategy.stairs.buy_and_sell.rate_computed import BsRcSoftCostIncreaseD

class StandartStrategy(unittest.TestCase):
    def setUp(self):
        self._stairs = BsRcSoftCostIncreaseD()
...
class Test1_ID(unittest.TestCase):
    def test_GetID(self):
        self.assertEqual(BsRcSoftCostIncreaseD.GetID(), const.ID.BsRcSoftCostIncreaseD)
...
class Test2_save_and_restore_from_string(StandartStrategy):
    def test1(self):
        ...
        restore_stairs = BsRcSoftCostIncreaseD.RestoreFromRecoveryString(recovery_string)
...
class Test3_save_and_restore_from_file(StandartStrategy):
    def setUp(self):
        ...
        self._save_filepath = os.path.join(faf.SplitPath1(sys.argv[0]), "stairs-BsRcSoftCostIncreaseD.save_file.log")
    ...
    def test1(self):
        ...
        restore_stairs = BsRcSoftCostIncreaseD.RestoreFromFile(filepath)
        self.CompareTwoStrategy(self._stairs, restore_stairs)
...
class Test5_StairsSoftCostIncreaseDS2(unittest.TestCase, Test_Srairs):
    def setUp(self):
        Test_Srairs.__init__(self, BsRcSoftCostIncreaseD(), "BsRcSoftCostIncreaseD.log")
        self._stairs.SetAvailableCurrency("1400")
        self._stairs.SetCommissionBuy("1")
        self._stairs.SetCommissionSell("1")
        self._stairs.SetCoefficient1("1")
        self._stairs.SetCostPrecision("4")
        self._stairs.SetRatePrecision("4")
        self._stairs.SetQuantityPrecision("8")
        self._stairs.SetProfit("1.003")
        self._stairs.SetInitRate("1817.8007")
        self._stairs.SetInitCost("99.99999941")
        self._stairs.Init()
