...
from strategy.stairs.buy_and_sell.rate_computed import RCSoftCostIncreaseD

class StandartStrategy(unittest.TestCase):
    def setUp(self):
        self._stairs = RCSoftCostIncreaseD()
...
class Test1_ID(unittest.TestCase):
    def test_GetID(self):
        self.assertEqual(RCSoftCostIncreaseD.GetID(), const.ID.RCSoftCostIncreaseD)
...
class Test2_save_and_restore_from_string(StandartStrategy):
    def test1(self):
        ...
        restore_stairs = RCSoftCostIncreaseD.RestoreFromRecoveryString(recovery_string)
...
class Test3_save_and_restore_from_file(StandartStrategy):
    def setUp(self):
        ...
        self._save_filepath = os.path.join(faf.SplitPath1(sys.argv[0]), "stairs-RCSoftCostIncreaseD.save_file.log")
    ...
    def test1(self):
        ...
        restore_stairs = RCSoftCostIncreaseD.RestoreFromFile(filepath)
        self.CompareTwoStrategy(self._stairs, restore_stairs)
...
class Test5_StairsSoftCostIncreaseDS2(unittest.TestCase, Test_Srairs):
    def setUp(self):
        Test_Srairs.__init__(self, RCSoftCostIncreaseD(), "RCSoftCostIncreaseD.log")
        ...
        self._stairs.SetQuantityPrecision("8")
        self._stairs.SetProfit("1.003")
        self._stairs.Init("1817.8007", "99.99999941")
