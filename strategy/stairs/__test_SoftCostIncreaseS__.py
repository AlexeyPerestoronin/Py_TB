...
from strategy.stairs import SoftCostIncreaseS

class StandartStrategy:
    def __init__ (self):
        self._stairs = SoftCostIncreaseS()
...
class Test1_StairsSoftCostIncreaseS(unittest.TestCase):
    def test_GetID(self):
        self.assertEqual(SoftCostIncreaseS.GetID(), const.ID.SOFT_COST_INCREASE_S)

class Test2_StairsSoftCostIncreaseS(unittest.TestCase, StandartStrategy):
    def setUp(self):
    ...
    def test_SaveAndRestore_from_string(self):
        ...
        restore_stairs = SoftCostIncreaseS.RestoreFromRecoveryString(recovery_string)
...
class Test3_StairsSoftCostIncreaseS(unittest.TestCase, StandartStrategy):
    def setUp(self):
        StandartStrategy.__init__(self)
        self._save_filepath = os.path.join(faf.SplitPath1(sys.argv[0]), "stairs-SoftCostIncreaseS.save_file.log")
    ...
    def test_SaveAndRestore_from_file(self):
        ...
        restore_stairs = SoftCostIncreaseS.RestoreFromFile(filepath)
        self.assertTrue(self._stairs.GetStep(), restore_stairs.GetStep())
        self.assertTrue(self._stairs.GetBuyRate(), restore_stairs.GetBuyRate())
        self.assertTrue(self._stairs.GetSellRate(), restore_stairs.GetSellRate())
        self.assertTrue(self._stairs.GetInfo(), restore_stairs.GetInfo())
...
class Test4_StairsSoftCostIncreaseS(unittest.TestCase, Test_Srairs):
    def setUp(self):
        Test_Srairs.__init__(self, SoftCostIncreaseS(), "StairsSoftCostIncreaseS-BTC_USD.log")
...
class Test5_StairsSoftCostIncreaseS(unittest.TestCase, Test_Srairs):
    def setUp(self):
        Test_Srairs.__init__(self, SoftCostIncreaseS(), "StairsSoftCostIncreaseS-ETH_USDT.log")
        self._stairs.SetAvailableCurrency(1400)
