...
from strategy.stairs import CostComputedS
...
class Test1_ID(unittest.TestCase):
    def test_GetID(self):
        self.assertEqual(CostComputedS.GetID(), const.ID.COST_COMPUTED_S)
...
class Test2_save_and_restore_from_string(StandartStrategy):
    def test1(self):
        ...
        restore_stairs = CostComputedS.RestoreFromRecoveryString(recovery_string)
...
class Test3_save_and_restore_from_file(StandartStrategy):
    def setUp(self):
        ...
        self._save_filepath = os.path.join(faf.SplitPath1(sys.argv[0]), "stairs-CostComputedS.save_file.log")
    ...
    def test1(self):
        ...
        restore_stairs = CostComputedS.RestoreFromFile(filepath)
        self.CompareTwoStrategy(self._stairs, restore_stairs)
